...
import tech.hombre.bluetoothchat.data.internal.CommunicationProxy
import tech.hombre.bluetoothchat.data.internal.EmptyProxy
import tech.hombre.bluetoothchat.data.service.BluetoothConnectionService
...
import tech.hombre.bluetoothchat.utils.safeRemove
import java.io.File
...
class BluetoothConnectorImpl(private val context: Context) : BluetoothConnector {
    ...
    private val connection = object : ServiceConnection {
        ...
        override fun onServiceConnected(className: ComponentName, binder: IBinder) {
            ...
            proxy = if (tech.hombre.bluetoothchat.BuildConfig.AUTORESPONDER) AutoresponderProxy(service) else EmptyProxy()
